#!/usr/bin/env python3
"""
D.Pharm Ranklist PDF → Excel Converter
Reads database/dpharm_ranklist.pdf and writes results/dpharm_ranklist.xlsx
...
PDF_PATH   = os.path.join(BASE_DIR, "database", "dpharm_ranklist.pdf")
RESULT_DIR = os.path.join(BASE_DIR, "results")
OUT_PATH   = os.path.join(RESULT_DIR, "dpharm_ranklist.xlsx")
...
ODD_ROW_FILL  = PatternFill("solid", fgColor="EEF4FB")
...
def write_excel(rows: list[list], out_path: str):
    ...
    ws = wb.active
    ws.title = "D.Pharm Ranklist"

    # Title row
    title_text = "Diploma in Pharmacy 2026-2027 — Provisional Rank List for Eligible Candidates"
